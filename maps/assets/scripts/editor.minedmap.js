...
window.createMap = function () {
	(async function () {
		...
		if (pathname.data != 'endrya'){
			spawnMarker = L.marker([-spawn.z, spawn.x], {icon: SpawnIcon, pmIgnore: true}).addTo(map) // [-z, x]
				.bindTooltip('<b class="ultradarkblue">Spawn</b>');
		}
		else {
			spawnMarker = L.marker([0, 0], {icon: SpawnIcon, pmIgnore: true}).addTo(map) // [-z, x]
				.bindTooltip('<b class="ultradarkblue">Spawn</b>');
		}
		...
		if (json) {
			for (let one in json.polygons) {
				...
				switch (subdata.type) {
					case 'Circle':
						polygons.push(
							L.circle(JSON.parse(subdata.coords)[0], {color: subdata.color, fillColor: subdata.color, fillOpacity: 0.2, radius: JSON.parse(subdata.coords)[1], pmIgnore: !subdata.authorisation, dbid: subdata.dbid, option: subdata.option}).addTo(map)
					...
					case 'Line':
						polygons.push(
							L.polygon(JSON.parse(subdata.coords), {color: subdata.color, pmIgnore: !subdata.authorisation, dbid: subdata.dbid, option: subdata.option}).addTo(map)
								.bindPopup(subdata.popup, {'className': 'customPopup'})
						);
						break;
					...
					case 'Markers':
						polygons.push(
							L.marker(JSON.parse(subdata.coords), {icon: subdata.icon, pmIgnore: !subdata.authorisation, dbid: subdata.dbid, option: subdata.option}).addTo(map) // [-z, x]
								.bindTooltip('')
								.bindPopup(subdata.popup, {'className': 'customPopup'})
						);
						break;
					...
					case 'Text':
						polygons.push(
							L.marker(JSON.parse(subdata.coords), {textMarker: true, text: subdata.text, pmIgnore: false, dbid: subdata.dbid, option: subdata.option}).addTo(map) // [-z, x];"
						);
						break;
				}
			}
			...
			for (let one in json.markers) {
				...
				switch (subdata.type) {
					case 'Markers':
						markers.push(
							L.marker(JSON.parse(subdata.coords), {icon: subdata.icon, pmIgnore: true, dbid: subdata.dbid, option: subdata.option}).addTo(map) // [-z, x]
		...
		for (let index = 0; index < polygons.length; index++) {
			...
			element.on('pm:edit', (e) => {
				...
				if (update != true) {
					if (e.shape == 'Line') {
						JSONLayers.push({'pm': "edit", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'latlngs': e.layer._latlngs, 'delete': false});
					}
					else if (e.shape == 'Polygon' || e.shape == 'Rectangle') {
						JSONLayers.push({'pm': "edit", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'latlngs': e.layer._latlngs[0], 'delete': false});
					}
					else if (e.shape == 'Marker') {
						JSONLayers.push({'pm': "edit", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'x': e.layer._latlng.lng, 'z': e.layer._latlng.lat, 'delete': false});
					}
					else if (e.shape == 'Text') {
						JSONLayers.push({'pm': "edit", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'x': e.layer._latlng.lng, 'z': e.layer._latlng.lat, 'text': e.layer.options.text, 'delete': false});
					}
					else if (e.shape == 'Circle') {
						JSONLayers.push({'pm': "edit", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'x': e.layer._latlng.lng, 'z': e.layer._latlng.lat, 'radius': e.layer._radius, 'delete': false});
					}
				}
				logEvent(JSONLayers);
			});
			...
			element.on('pm:remove', (e) => {
				...
				if (update != true) {
					if (e.shape == 'Line') {
						JSONLayers.push({'pm': "remove", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'latlngs': e.layer._latlngs, 'delete': true});
					}
					else if (e.shape == 'Polygon' || e.shape == 'Rectangle') {
						JSONLayers.push({'pm': "remove", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'latlngs': e.layer._latlngs[0], 'delete': true});
					}
					else if (e.shape == 'Marker') {
						JSONLayers.push({'pm': "remove", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'x': e.layer._latlng.lng, 'z': e.layer._latlng.lat, 'delete': true});
					}
					else if (e.shape == 'Text') {
						JSONLayers.push({'pm': "remove", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'x': e.layer._latlng.lng, 'z': e.layer._latlng.lat, 'text': e.layer.options.text, 'delete': true});
					}
					else if (e.shape == 'Circle') {
						JSONLayers.push({'pm': "remove", 'id': e.layer._leaflet_id, 'dbid': e.layer.options.dbid, 'option': e.layer.options.option, 'type': e.shape, 'x': e.layer._latlng.lng, 'z': e.layer._latlng.lat, 'radius': e.layer._radius, 'delete': true});
					}
				}
				logEvent(JSONLayers);
			});
